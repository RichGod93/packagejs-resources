...
const Component = function (
	...
	this.onClickMenuToggle = async (event) => {
		...
		&& !(event.metaKey || event.ctrlKey)) {
			...
			// @action
			this.navigator.state.window.document.querySelector('#app').setAttribute(
				'class',
				(menuOpen ? 'menuOpen' : '')
			);
	...
	this.render = function () {
		return (<main>
			...
			<header class="inverted">
			  <small>
				  <a onClick={((e) => { this.ma_go(e, this.navigator.dom.root, true) })} href="/"><img src="/static/images/logo.png" /></a>
				</small>
				<nav>
				  <hr />
				  <small>
					  <a onClick={((e) => { this.ma_go(e, '/about', true) })} href="/about"><strong>About</strong></a>
						<a href=""><strong>Press</strong></a>
						<a href=""><strong>Scheduling</strong></a>
						<a href=""><strong>Contact</strong></a>
						<a href=""><strong>Request a greeting</strong></a>
						{this.navigator.state.options.deployment !== 'live' && this.navigator.context.name === '$dom:root' ? (<>
							<a onClick={this.onClickAddNode}><strong>Add new post</strong></a>
						</>) : (<></>)}
						{this.navigator.state.options.deployment !== 'live' && this.navigator.context.name === '$dom:item/db.posts' ? (<>
							<a onClick={this.onClickEditNode}><strong>Edit post</strong></a>
						</>) : (<></>)}
					</small>
					<hr />
				</nav>
			...
			<footer class="inverted">
			  <small>
				  <img src="/static/images/logo.png" /><br />
					<strong>An Example Website in the Style of The President</strong>
				</small>
